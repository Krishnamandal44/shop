...
int count=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent i=new Intent(List_View_Show.this,Buy_Now.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(List_View_Show.this,Getproduct.class);
                startActivity(i);
            }
        });
    ...
    protected void check()
    {
        ...
        if(icount>0)
        {
            ...
            Intent i=new Intent(List_View_Show.this,Add_To_Cart.class);
